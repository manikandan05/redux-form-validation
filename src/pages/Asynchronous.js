...
const asyncValidate = values => {
    return sleep(500)
        .then(() => {
            if (['abc@in.com', 'def@in.com', 'ghi@in.com', 'jkl@in.com', 'mno@in.com', 'pqr@in.com'].includes(values.email)) {
                throw { email: 'Given Email ID is already taken!' };
            }
        });
}
...
let Asynchronous = (props) => {
    const { pristine, reset, submitting, handleSubmit } = props;
    return (
        <div className='form-layout'>
            <div className='header'>Asynchronous From Validation</div>
